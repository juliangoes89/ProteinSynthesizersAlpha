...
public class RocketController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (currentRocket != null)
		{
			...
			CollisionHandler collisionInstance = currentRocket.GetComponent<CollisionHandler>();
			if (collisionInstance.isTransitioning)
			{
				...
				if (currentRocket.GetComponent<Mover>() == null) {
					currentRocket.AddComponent<Mover>();
				}
